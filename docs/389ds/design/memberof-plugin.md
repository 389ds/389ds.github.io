...
-   Written such that "memberOf" should be excluded from being replicated, which puts MMR out of the picture since fractional replication isn't supported between two suppliers.
...
-   Make "memberOf" work with multi-supplier replication. [**done**]
