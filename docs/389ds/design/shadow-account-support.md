...
Previously, shadowAccount was not explicitly supported. 
For instance, one of the attribute type shadowLastChange is supposed to be updated when the password of the account is modified, but it was not.
